...
public class CommonMapper {
  ...
  public DealDto getDtoFromEntity(Deal entity) {
    BoundMapperFacade<Deal, DealDto> mapper = mapperFactory
        .getMapperFacade(Deal.class, DealDto.class);
    return mapper.map(entity);
  }
  ...
  public ItemDto getDtoFromEntity(Item entity) {
    BoundMapperFacade<Item, ItemDto> mapper = mapperFactory
        .getMapperFacade(Item.class, ItemDto.class);
    return mapper.map(entity);
  }
  ...
  public UserDto getDtoFromEntity(User entity) {
    BoundMapperFacade<User, UserDto> mapper = mapperFactory
        .getMapperFacade(User.class, UserDto.class);
    return mapper.map(entity);
  }
